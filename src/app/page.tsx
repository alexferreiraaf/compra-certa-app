    ...
    <div className="container mx-auto flex h-screen items-center justify-center p-4">
      <Card className="w-full max-w-sm bg-card/80 border-0 shadow-lg">
        ...
        <form onSubmit={handleLogin}>
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                 ...
                 <Button type="submit" className="w-full text-lg bg-accent hover:bg-accent/90 text-accent-foreground mt-4" size="lg" disabled={isLoading}>
        ...
        <CardFooter className="flex-col space-y-3">
            ...
            <Button onClick={handleGoogleLogin} variant="outline" className="w-full text-lg" size="lg" disabled={isGoogleLoading}>
